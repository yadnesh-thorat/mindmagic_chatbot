...
export const PREFERENCE_META = {
    Wellness: { emoji: "🪷", color: "#10b981", label: "Wellness", bot: "Anya" },
    Motivation: { emoji: "🔥", color: "#f59e0b", label: "Motivation", bot: "Arjun" },
    Philosophy: { emoji: "🌀", color: "#8b5cf6", label: "Philosophy", bot: "Ishaan" },
    Jokes: { emoji: "😄", color: "#ec4899", label: "Jokes", bot: "Kabir" },
};
